...
<body class="text-gray-200 font-sans antialiased selection:bg-element-gold selection:text-black">
            ...
            <div class="flex items-center justify-between h-20">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-6">
                        ...
                        <a href="#collection-tabs" class="hover:text-element-gold px-3 py-2 text-sm font-medium transition-colors">Collection</a>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16">
                ...
                <div class="flex flex-wrap justify-center gap-4 md:gap-12 border-b border-white/30 pb-1 max-w-3xl mx-auto">
                    <button onclick="switchTab('metals')" id="btn-metals" class="tab-btn active-tab text-lg md:text-xl font-bold px-4 py-2 text-element-gold border-b-4 border-element-gold transition-all duration-300 drop-shadow-sm">
                        Metals
                    </button>
                    <button onclick="switchTab('curios')" id="btn-curios" class="tab-btn text-lg md:text-xl font-bold px-4 py-2 text-blue-100 border-b-4 border-transparent hover:text-white transition-all duration-300 drop-shadow-sm">
                        Curios
                    </button>
                    <button onclick="switchTab('antiques')" id="btn-antiques" class="tab-btn text-lg md:text-xl font-bold px-4 py-2 text-blue-100 border-b-4 border-transparent hover:text-white transition-all duration-300 drop-shadow-sm">
                        Antiques
                    </button>
                </div>
            </div>
            ...
            <div class="relative min-h-[400px]">
                <div id="content-metals" class="tab-content grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 animate-fade-in">
                    <div class="group h-80 rounded-2xl overflow-hidden cursor-pointer shadow-lg border border-white/20 transition-all duration-500 hover:-translate-y-4 hover:shadow-2xl hover:shadow-element-gold/40">
                        <img src="{{ asset('/assets/Uranium-Pictures-.jpg') }}" class="w-full h-full object-cover transform transition duration-700 group-hover:scale-110">
                    </div>
                    <div class="group h-80 rounded-2xl overflow-hidden cursor-pointer shadow-lg border border-white/20 transition-all duration-500 hover:-translate-y-4 hover:shadow-2xl hover:shadow-element-gold/40">
                        <img src="{{ asset('/assets/old-gold-mine-.jpg') }}" class="w-full h-full object-cover transform transition duration-700 group-hover:scale-110">
                    </div>
                    <div class="group h-80 rounded-2xl overflow-hidden cursor-pointer shadow-lg border border-white/20 transition-all duration-500 hover:-translate-y-4 hover:shadow-2xl hover:shadow-element-gold/40">
                        <img src="{{ asset('/assets/uncut.jpg') }}" class="w-full h-full object-cover transform transition duration-700 group-hover:scale-110">
                    </div>
                    <div class="group h-80 rounded-2xl overflow-hidden cursor-pointer shadow-lg border border-white/20 transition-all duration-500 hover:-translate-y-4 hover:shadow-2xl hover:shadow-element-gold/40">
                        <img src="{{ asset('/assets/radio.jpg') }}" class="w-full h-full object-cover transform transition duration-700 group-hover:scale-110">
                    </div>
                </div>
                ...
                <div id="content-curios" class="tab-content hidden grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 animate-fade-in">
                    ...
                    <div class="group h-80 rounded-2xl overflow-hidden cursor-pointer shadow-lg border border-white/20 transition-all duration-500 hover:-translate-y-4 hover:shadow-2xl hover:shadow-element-blue/40">
                        <img src="https://images.unsplash.com/photo-1605518216965-7f39499df5e9?q=80&w=600" class="w-full h-full object-cover transform transition duration-700 group-hover:scale-110">
                    </div>
                    <div class="group h-80 rounded-2xl overflow-hidden cursor-pointer shadow-lg border border-white/20 transition-all duration-500 hover:-translate-y-4 hover:shadow-2xl hover:shadow-element-blue/40">
                        <img src="https://images.unsplash.com/photo-1615800098779-1be32e60cca3?q=80&w=600" class="w-full h-full object-cover transform transition duration-700 group-hover:scale-110">
                    </div>
                    <div class="group h-80 rounded-2xl overflow-hidden cursor-pointer shadow-lg border border-white/20 transition-all duration-500 hover:-translate-y-4 hover:shadow-2xl hover:shadow-element-blue/40">
                        <img src="https://images.unsplash.com/photo-1599839572628-36376936f3ef?q=80&w=600" class="w-full h-full object-cover transform transition duration-700 group-hover:scale-110">
                    </div>
                </div>

                <div id="content-antiques" class="tab-content hidden grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 animate-fade-in">
                    <div class="group h-80 rounded-2xl overflow-hidden cursor-pointer shadow-lg border border-white/20 transition-all duration-500 hover:-translate-y-4 hover:shadow-2xl hover:shadow-element-rose/40">
                        <img src="https://images.unsplash.com/photo-1547996160-81dfa63595aa?q=80&w=600" class="w-full h-full object-cover transform transition duration-700 group-hover:scale-110">
                    </div>
                    <div class="group h-80 rounded-2xl overflow-hidden cursor-pointer shadow-lg border border-white/20 transition-all duration-500 hover:-translate-y-4 hover:shadow-2xl hover:shadow-element-rose/40">
                        <img src="https://images.unsplash.com/photo-1596627689912-3b1a85b9c240?q=80&w=600" class="w-full h-full object-cover transform transition duration-700 group-hover:scale-110">
                    </div>
                    <div class="group h-80 rounded-2xl overflow-hidden cursor-pointer shadow-lg border border-white/20 transition-all duration-500 hover:-translate-y-4 hover:shadow-2xl hover:shadow-element-rose/40">
                        <img src="https://images.unsplash.com/photo-1576504677634-06b71343d327?q=80&w=600" class="w-full h-full object-cover transform transition duration-700 group-hover:scale-110">
                    </div>
                    <div class="group h-80 rounded-2xl overflow-hidden cursor-pointer shadow-lg border border-white/20 transition-all duration-500 hover:-translate-y-4 hover:shadow-2xl hover:shadow-element-rose/40">
                        <img src="https://images.unsplash.com/photo-1461360370896-922624d12aa1?q=80&w=600" class="w-full h-full object-cover transform transition duration-700 group-hover:scale-110">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="our-work" class="py-24 relative z-20 border-t border-white/10">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-3xl md:text-4xl font-bold text-white mb-8 drop-shadow-md">Our <span class="text-element-gold">Work</span></h2>
            
            <div class="space-y-8">
                <p class="text-xl md:text-2xl text-white/90 font-light leading-relaxed">
                    At Five Elements, our work goes beyond simple trading. We are the custodians of history and the facilitators of modern value.
                </p>
                
                <div class="grid md:grid-cols-3 gap-8 mt-12">
                    <div class="p-6 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors">
                        <h3 class="text-xl font-bold text-element-gold mb-3">Authentication</h3>
                        <p class="text-gray-300">Rigorous verification of rare curios and antiques using traditional expertise combined with modern analysis.</p>
                    </div>
                    <div class="p-6 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors">
                        <h3 class="text-xl font-bold text-element-gold mb-3">Procurement</h3>
                        <p class="text-gray-300">Sourcing high-grade industrial metals and investment-grade bullion for our discerning global clientele.</p>
                    </div>
                    <div class="p-6 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors">
                        <h3 class="text-xl font-bold text-element-gold mb-3">Preservation</h3>
                        <p class="text-gray-300">Ensuring the legacy of cultural artifacts through proper handling, restoration, and secure logistics.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="relative rounded-2xl overflow-hidden border border-white/20 shadow-2xl group">
                    ...
                    <img src="{{ asset('/assets/legacy.jpg') }}" alt="Our Story" class="w-full h-[400px] object-cover transform group-hover:scale-105 transition duration-700">
                </div>
                
                <div class="space-y-6">
                    <h3 class="text-2xl font-semibold text-white tracking-wide drop-shadow-sm">Born in the City of Joy</h3>
                    <p class="text-white/80 leading-relaxed text-lg">
                        Established in <span class="text-white font-semibold">Kolkata (2025)</span>, Five Elements was founded on a distinct vision: to bridge the gap between traditional craftsmanship and modern trade.
                    </p>
                    <p class="text-white/80 leading-relaxed">
                        We specialize in the <strong>trading (purchasing & selling)</strong> of curated items. From original metals to specially processed Curio items, our portfolio is diverse. Whether it is an antique handed down through generations or a unique metal artifact, we ensure transparency and value in every transaction.
                    </p>
                    <div class="pt-4 flex items-center gap-4">
                        <div class="h-12 w-1 bg-gradient-to-b from-element-gold to-transparent rounded-full"></div>
                        <div>
                            <p class="text-element-gold font-bold uppercase text-sm tracking-widest">Est. 2025</p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 gap-8 rounded-3xl overflow-hidden glass-panel border border-white/30">
                ...
                <div class="p-8 md:p-12 flex flex-col justify-center bg-black/20">
                    ...
                    <div class="space-y-6 text-lg text-gray-200">
                        <div class="flex items-start gap-4">
                            <i class="fa-solid fa-location-dot text-element-gold text-2xl mt-1"></i>
                            <div>
                                <p class="font-bold text-white">Five Elements Trading</p>
                                <p>123, Park Street Area</p>
                                <p>Kolkata, West Bengal, 700016</p>
                                <p>India</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-4">
                            <i class="fa-solid fa-phone text-element-gold text-2xl"></i>
                            <p>+91 98765 43210</p>
                        </div>
                        <div class="flex items-center gap-4">
                            <i class="fa-solid fa-envelope text-element-gold text-2xl"></i>
                            <p>contact@fiveelements.com</p>
                        </div>
                        <div class="flex items-center gap-4">
                            <i class="fa-solid fa-clock text-element-gold text-2xl"></i>
                ...
                <div class="p-8 md:p-12">
                    ...
                    @if(session('success'))
                        <div class="bg-green-900/60 border border-green-500 text-green-200 px-4 py-3 rounded mb-4">
                            {{ session('success') }}
                        </div>
                    @endif
        ...
        <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl px-4">
            ...
            @else
                <div id="dashboardScreen" class="glass-panel p-8 rounded-2xl border border-green-500/30">
                    ...
                    <form action="{{ route('admin.upload') }}" method="POST" enctype="multipart/form-data" class="mb-8">
                        @csrf
                        <div class="border-2 border-dashed border-white/30 rounded-xl p-8 text-center hover:border-element-blue transition-colors bg-black/20 relative">
                            <input type="file" name="file" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer" onchange="this.form.submit()">
                            <i class="fa-solid fa-cloud-arrow-up text-3xl text-gray-300 mb-3"></i>
                            <p class="text-gray-300 font-medium">Click to upload document</p>
                        </div>
                    </form>
                    <div class="space-y-2 max-h-60 overflow-y-auto pr-2">
                        @foreach($documents as $doc)
                            <div class="bg-black/30 p-3 rounded-lg flex justify-between items-center hover:bg-black/50 transition-colors">
                                <div class="flex items-center gap-3">
                                    <i class="fa-regular fa-file text-element-blue"></i>
                                    <a href="{{ Storage::url($doc->path) }}" target="_blank" class="text-sm text-gray-200 hover:text-white underline font-medium">
                                        {{ $doc->filename }}
                                    </a>
                                </div>
                                <span class="text-xs text-gray-400">{{ $doc->created_at->diffForHumans() }}</span>
                            </div>
                        @endforeach
                    </div>
                </div>
